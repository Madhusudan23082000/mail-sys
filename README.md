...
<html lang="en">
  <head>
    ...
    <title>Java Mini Project - Free Bootstrap CSS Template</title>
          ...
          <div class="col-12">
            ...
            <div class="ml-auto mr-0 tm-bg-black-transparent text-white tm-brand-container-inner">
              <div class="tm-brand-container text-center">
                <h1 class="tm-brand-name">Java Mini Project</h1>
                <p class="tm-brand-description mb-0">Intranet Mailing System</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row h-100">
            ...
            <div class="col-md-7 tm-welcome-left-col">
              <div class="tm-welcome-left">
                <h2 class="tm-welcome-title">Welcome to Our Project</h2>
                <p class="pb-0">
            ...
            <div class="col-md-5">
              <div class="tm-welcome-right">
                ...
                <p class="mb-0">
                 This mailing system can be used for the companies as well as institutes without Internet 
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-12">
            <div class="tm-portfolio-item">
              ...
              <div class="tm-portfolio-description">
                <h3 class="tm-text-green">
                  Prince Pandey
                  <span class="tm-title-small">(2020 Java Presentation)</span>
                </h3>
                <p class="mb-0">
                  Roll no. 35<br>
                  E-mail- vickypp007961@gmail.com<br>
                  Contact: 9975192991
                </p>
              </div>
            </div>
            ...
            <div class="tm-portfolio-item">
              ...
              <div class="tm-portfolio-description">
                ...
                <p class="mb-0">
                  Roll no. 34<br>
                 Contact: 7757869517<br>
                 E-mail: pandeynaman23082000@gmail.com
                </p>
              </div>
            </div>
            ...
            <div class="tm-portfolio-item">
              ...
              <div class="tm-portfolio-description">
                ...
                <p class="mb-0">
                  Roll no. 33<br>
                  Contact: 9082966402<br>
                  E-mail: pals55002@gmail.com
                </p>
              </div>
            </div>
          ...
          <div class="col-12">
            <div class="tm-contact-items-container">
              <div class="tm-contact-item">
                ...
                <p class="mb-0">
                  This is fast working model use for commercial purpose. Can be used in offices and in companies.
                </p>
              </div>
              <div class="tm-contact-item">
                <i class="fas fa-5x fa-building tm-contact-item-icon"></i>
                <p class="mb-0">
                  This model also helps to exchange their views through mails and send electronic files through attachments.
                </p>
              </div>
              ...
              <div class="tm-contact-item">
                ...
                <p class="mb-0">
                  The user is NOT allowed to misuse this model, misleading may cause severe action.
                </p>
              </div>
            </div>
          </div>
